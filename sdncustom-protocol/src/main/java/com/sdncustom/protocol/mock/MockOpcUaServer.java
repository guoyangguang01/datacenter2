 ...
 * 提供完整的 OPC-UA 协议支持，包括地址空间、订阅、安全等
 */
@Slf4j
public class MockOpcUaServer {
    ...
    private class MockNamespace extends ManagedNamespaceWithLifecycle {
        ...
        private void createNodes() {
            ...
            nodeManager.addReference(Reference.create(
        ...
        private void createVariableNode(UaNodeContext context, UaFolderNode parent, String name, String description, Object value) {
            ...
            variableNode.setAccessLevel(UByte.valueOf(AccessLevel.READ_WRITE.getValue()));
            variableNode.setUserAccessLevel(UByte.valueOf(AccessLevel.READ_WRITE.getValue()));
        ...
        private static class AccessLevel {
            static final UByte READ_WRITE = UByte.valueOf(3);
        }
    }
